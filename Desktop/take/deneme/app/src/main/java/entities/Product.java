...
//    }
    ...
    public void decreaseSplitCount() { this.splitCount = splitCount--; }

    public void setDrink(Boolean d) {
        this.drink = d;
    }
    ...
    public void setName(String name) {
        ...
        if (getName() != null && (this.getName().endsWith("cl") || this.getName().endsWith(" l") ||
                this.getName().endsWith("L)") || this.getName().endsWith("cl)") ||
                (getCategory() != null && this.getCategory().contains("Getränke")))) {
            this.drink = true;
        } else {
            this.drink = false;
        }
